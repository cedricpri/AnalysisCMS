...
// Tue Jul  3 17:37:24 2018 by ROOT version 6.10/09
// from TTree Events/Events
// found on file: /eos/cms/store/group/phys_higgs/cmshww/amassiro/HWWNano/Fall2017_nAOD_v1_Study2017/MCl1loose2017__baseW/nanoLatino_DYJetsToLL_M-50-LO-ext1__part0.root
//////////////////////////////////////////////////////////
...
public :
   ...
   TTreeReaderArray<Float_t> Lepton_eCorr = {fReader, "Lepton_eCorr"};
   TTreeReaderValue<UInt_t> nVetoLepton = {fReader, "nVetoLepton"};
   TTreeReaderArray<Int_t> VetoLepton_pdgId = {fReader, "VetoLepton_pdgId"};
   TTreeReaderArray<Int_t> VetoLepton_electronIdx = {fReader, "VetoLepton_electronIdx"};
   TTreeReaderArray<Int_t> VetoLepton_muonIdx = {fReader, "VetoLepton_muonIdx"};
   TTreeReaderArray<Float_t> VetoLepton_pt = {fReader, "VetoLepton_pt"};
   TTreeReaderArray<Float_t> VetoLepton_eta = {fReader, "VetoLepton_eta"};
   TTreeReaderArray<Float_t> VetoLepton_phi = {fReader, "VetoLepton_phi"};
   TTreeReaderArray<Float_t> VetoLepton_eCorr = {fReader, "VetoLepton_eCorr"};
   TTreeReaderValue<UInt_t> nCleanJet = {fReader, "nCleanJet"};
   TTreeReaderArray<Int_t> CleanJet_jetIdx = {fReader, "CleanJet_jetIdx"};
   ...
   TTreeReaderArray<Int_t> Lepton_isLoose = {fReader, "Lepton_isLoose"};
   TTreeReaderArray<Int_t> Lepton_isVeto = {fReader, "Lepton_isVeto"};
   TTreeReaderArray<Int_t> Lepton_isWgs = {fReader, "Lepton_isWgs"};
   TTreeReaderValue<Float_t> dmZll_veto = {fReader, "dmZll_veto"};
   ...
   TTreeReaderValue<Float_t> yll = {fReader, "yll"};
   TTreeReaderValue<Float_t> ptll = {fReader, "ptll"};
   TTreeReaderValue<Float_t> pt1 = {fReader, "pt1"};
   TTreeReaderValue<Float_t> pt2 = {fReader, "pt2"};
   TTreeReaderValue<Float_t> mth = {fReader, "mth"};
   TTreeReaderValue<Float_t> mcoll = {fReader, "mcoll"};
   TTreeReaderValue<Float_t> mcollWW = {fReader, "mcollWW"};
   TTreeReaderValue<Float_t> mTi = {fReader, "mTi"};
   TTreeReaderValue<Float_t> mTe = {fReader, "mTe"};
   TTreeReaderValue<Float_t> choiMass = {fReader, "choiMass"};
   TTreeReaderValue<Float_t> mR = {fReader, "mR"};
   TTreeReaderValue<Float_t> mT2 = {fReader, "mT2"};
   TTreeReaderValue<Float_t> channel = {fReader, "channel"};
   TTreeReaderValue<Float_t> drll = {fReader, "drll"};
   TTreeReaderValue<Float_t> dphilljet = {fReader, "dphilljet"};
   TTreeReaderValue<Float_t> dphilljetjet = {fReader, "dphilljetjet"};
   TTreeReaderValue<Float_t> dphilljetjet_cut = {fReader, "dphilljetjet_cut"};
   TTreeReaderValue<Float_t> dphillmet = {fReader, "dphillmet"};
   TTreeReaderValue<Float_t> dphilmet = {fReader, "dphilmet"};
   TTreeReaderValue<Float_t> dphilmet1 = {fReader, "dphilmet1"};
   TTreeReaderValue<Float_t> dphilmet2 = {fReader, "dphilmet2"};
   TTreeReaderValue<Float_t> mtw1 = {fReader, "mtw1"};
   TTreeReaderValue<Float_t> mtw2 = {fReader, "mtw2"};
   TTreeReaderValue<Float_t> mjj = {fReader, "mjj"};
   TTreeReaderValue<Float_t> detajj = {fReader, "detajj"};
   TTreeReaderValue<Float_t> njet = {fReader, "njet"};
   TTreeReaderValue<Float_t> mllWgSt = {fReader, "mllWgSt"};
   TTreeReaderValue<Float_t> drllWgSt = {fReader, "drllWgSt"};
   TTreeReaderValue<Float_t> mllThird = {fReader, "mllThird"};
   TTreeReaderValue<Float_t> mllOneThree = {fReader, "mllOneThree"};
   TTreeReaderValue<Float_t> mllTwoThree = {fReader, "mllTwoThree"};
   TTreeReaderValue<Float_t> drllOneThree = {fReader, "drllOneThree"};
   TTreeReaderValue<Float_t> drllTwoThree = {fReader, "drllTwoThree"};
   TTreeReaderValue<Float_t> dphijet1met = {fReader, "dphijet1met"};
   TTreeReaderValue<Float_t> dphijet2met = {fReader, "dphijet2met"};
   TTreeReaderValue<Float_t> dphijjmet = {fReader, "dphijjmet"};
   TTreeReaderValue<Float_t> dphijjmet_cut = {fReader, "dphijjmet_cut"};
   TTreeReaderValue<Float_t> dphilep1jet1 = {fReader, "dphilep1jet1"};
   TTreeReaderValue<Float_t> dphilep1jet2 = {fReader, "dphilep1jet2"};
   TTreeReaderValue<Float_t> dphilep2jet1 = {fReader, "dphilep2jet1"};
   TTreeReaderValue<Float_t> dphilep2jet2 = {fReader, "dphilep2jet2"};
   TTreeReaderValue<Float_t> ht = {fReader, "ht"};
   TTreeReaderValue<Float_t> vht_pt = {fReader, "vht_pt"};
   TTreeReaderValue<Float_t> vht_phi = {fReader, "vht_phi"};
   TTreeReaderValue<Float_t> projpfmet = {fReader, "projpfmet"};
   TTreeReaderValue<Float_t> dphiltkmet = {fReader, "dphiltkmet"};
   TTreeReaderValue<Float_t> projtkmet = {fReader, "projtkmet"};
   TTreeReaderValue<Float_t> mpmet = {fReader, "mpmet"};
   TTreeReaderValue<Float_t> pTWW = {fReader, "pTWW"};
   TTreeReaderValue<Float_t> recoil = {fReader, "recoil"};
   TTreeReaderValue<Float_t> jetpt1_cut = {fReader, "jetpt1_cut"};
   TTreeReaderValue<Float_t> jetpt2_cut = {fReader, "jetpt2_cut"};
   TTreeReaderValue<Float_t> dphilljet_cut = {fReader, "dphilljet_cut"};
   TTreeReaderValue<Float_t> dphijet1met_cut = {fReader, "dphijet1met_cut"};
   TTreeReaderValue<Float_t> dphijet2met_cut = {fReader, "dphijet2met_cut"};
   TTreeReaderValue<Float_t> PfMetDivSumMet = {fReader, "PfMetDivSumMet"};
   TTreeReaderValue<Float_t> upara = {fReader, "upara"};
   TTreeReaderValue<Float_t> uperp = {fReader, "uperp"};
   TTreeReaderValue<Float_t> m2ljj20 = {fReader, "m2ljj20"};
   TTreeReaderValue<Float_t> m2ljj30 = {fReader, "m2ljj30"};
   TTreeReaderValue<Float_t> mllmin3l = {fReader, "mllmin3l"};
   TTreeReaderValue<Float_t> zveto_3l = {fReader, "zveto_3l"};
   TTreeReaderValue<Float_t> pt3 = {fReader, "pt3"};
   TTreeReaderValue<Float_t> eta1 = {fReader, "eta1"};
   TTreeReaderValue<Float_t> eta2 = {fReader, "eta2"};
   TTreeReaderValue<Float_t> eta3 = {fReader, "eta3"};
   TTreeReaderValue<Float_t> phi1 = {fReader, "phi1"};
   TTreeReaderValue<Float_t> phi2 = {fReader, "phi2"};
   TTreeReaderValue<Float_t> phi3 = {fReader, "phi3"};
   TTreeReaderValue<Float_t> drllmin3l = {fReader, "drllmin3l"};
   TTreeReaderValue<Float_t> njet_3l = {fReader, "njet_3l"};
   TTreeReaderValue<Float_t> nbjet_3l = {fReader, "nbjet_3l"};
   TTreeReaderValue<Float_t> chlll = {fReader, "chlll"};
   TTreeReaderValue<Float_t> pfmet = {fReader, "pfmet"};
   TTreeReaderValue<Float_t> mlll = {fReader, "mlll"};
   TTreeReaderValue<Float_t> flagOSSF = {fReader, "flagOSSF"};
   TTreeReaderValue<Float_t> mtwww = {fReader, "mtwww"};
   TTreeReaderValue<Float_t> mtw1_wh3l = {fReader, "mtw1_wh3l"};
   TTreeReaderValue<Float_t> mtw2_wh3l = {fReader, "mtw2_wh3l"};
   TTreeReaderValue<Float_t> mtw3_wh3l = {fReader, "mtw3_wh3l"};
   TTreeReaderValue<Float_t> minmtw_wh3l = {fReader, "minmtw_wh3l"};
   TTreeReaderValue<Float_t> mindphi_lmet = {fReader, "mindphi_lmet"};
   TTreeReaderValue<Float_t> dphilllmet = {fReader, "dphilllmet"};
   TTreeReaderValue<Float_t> ptlll = {fReader, "ptlll"};
   TTreeReaderValue<Float_t> pTWWW = {fReader, "pTWWW"};
   TTreeReaderValue<Float_t> dphilmet1_wh3l = {fReader, "dphilmet1_wh3l"};
   TTreeReaderValue<Float_t> dphilmet2_wh3l = {fReader, "dphilmet2_wh3l"};
   TTreeReaderValue<Float_t> dphilmet3_wh3l = {fReader, "dphilmet3_wh3l"};
   TTreeReaderValue<Float_t> ptbest = {fReader, "ptbest"};
   TTreeReaderValue<Float_t> pfmetPhi_zh4l = {fReader, "pfmetPhi_zh4l"};
   TTreeReaderValue<Float_t> z0Mass_zh4l = {fReader, "z0Mass_zh4l"};
   TTreeReaderValue<Float_t> z1Mass_zh4l = {fReader, "z1Mass_zh4l"};
   TTreeReaderValue<Float_t> zaMass_zh4l = {fReader, "zaMass_zh4l"};
   TTreeReaderValue<Float_t> zbMass_zh4l = {fReader, "zbMass_zh4l"};
   TTreeReaderValue<Float_t> flagZ1SF_zh4l = {fReader, "flagZ1SF_zh4l"};
   TTreeReaderValue<Float_t> z0DeltaPhi_zh4l = {fReader, "z0DeltaPhi_zh4l"};
   TTreeReaderValue<Float_t> z1DeltaPhi_zh4l = {fReader, "z1DeltaPhi_zh4l"};
   TTreeReaderValue<Float_t> zaDeltaPhi_zh4l = {fReader, "zaDeltaPhi_zh4l"};
   TTreeReaderValue<Float_t> zbDeltaPhi_zh4l = {fReader, "zbDeltaPhi_zh4l"};
   TTreeReaderValue<Float_t> minDeltaPhi_zh4l = {fReader, "minDeltaPhi_zh4l"};
   TTreeReaderValue<Float_t> z0DeltaR_zh4l = {fReader, "z0DeltaR_zh4l"};
   TTreeReaderValue<Float_t> z1DeltaR_zh4l = {fReader, "z1DeltaR_zh4l"};
   TTreeReaderValue<Float_t> zaDeltaR_zh4l = {fReader, "zaDeltaR_zh4l"};
   TTreeReaderValue<Float_t> zbDeltaR_zh4l = {fReader, "zbDeltaR_zh4l"};
   TTreeReaderValue<Float_t> lep1Mt_zh4l = {fReader, "lep1Mt_zh4l"};
   TTreeReaderValue<Float_t> lep2Mt_zh4l = {fReader, "lep2Mt_zh4l"};
   TTreeReaderValue<Float_t> lep3Mt_zh4l = {fReader, "lep3Mt_zh4l"};
   TTreeReaderValue<Float_t> lep4Mt_zh4l = {fReader, "lep4Mt_zh4l"};
   TTreeReaderValue<Float_t> minMt_zh4l = {fReader, "minMt_zh4l"};
   TTreeReaderValue<Float_t> z1Mt_zh4l = {fReader, "z1Mt_zh4l"};
   TTreeReaderValue<Float_t> mllll_zh4l = {fReader, "mllll_zh4l"};
   TTreeReaderValue<Float_t> chllll_zh4l = {fReader, "chllll_zh4l"};
   TTreeReaderArray<Float_t> Jet_btagSF = {fReader, "Jet_btagSF"};
   TTreeReaderArray<Float_t> Jet_btagSF_up = {fReader, "Jet_btagSF_up"};
   TTreeReaderArray<Float_t> Jet_btagSF_down = {fReader, "Jet_btagSF_down"};
   TTreeReaderArray<Float_t> Jet_btagSF_shape = {fReader, "Jet_btagSF_shape"};
   TTreeReaderArray<Float_t> Jet_btagSF_shape_up_jes = {fReader, "Jet_btagSF_shape_up_jes"};
   TTreeReaderArray<Float_t> Jet_btagSF_shape_down_jes = {fReader, "Jet_btagSF_shape_down_jes"};
   TTreeReaderArray<Float_t> Jet_btagSF_shape_up_lf = {fReader, "Jet_btagSF_shape_up_lf"};
   TTreeReaderArray<Float_t> Jet_btagSF_shape_down_lf = {fReader, "Jet_btagSF_shape_down_lf"};
   TTreeReaderArray<Float_t> Jet_btagSF_shape_up_hf = {fReader, "Jet_btagSF_shape_up_hf"};
   TTreeReaderArray<Float_t> Jet_btagSF_shape_down_hf = {fReader, "Jet_btagSF_shape_down_hf"};
   TTreeReaderArray<Float_t> Jet_btagSF_shape_up_hfstats1 = {fReader, "Jet_btagSF_shape_up_hfstats1"};
   TTreeReaderArray<Float_t> Jet_btagSF_shape_down_hfstats1 = {fReader, "Jet_btagSF_shape_down_hfstats1"};
   TTreeReaderArray<Float_t> Jet_btagSF_shape_up_hfstats2 = {fReader, "Jet_btagSF_shape_up_hfstats2"};
   TTreeReaderArray<Float_t> Jet_btagSF_shape_down_hfstats2 = {fReader, "Jet_btagSF_shape_down_hfstats2"};
   TTreeReaderArray<Float_t> Jet_btagSF_shape_up_lfstats1 = {fReader, "Jet_btagSF_shape_up_lfstats1"};
   TTreeReaderArray<Float_t> Jet_btagSF_shape_down_lfstats1 = {fReader, "Jet_btagSF_shape_down_lfstats1"};
   TTreeReaderArray<Float_t> Jet_btagSF_shape_up_lfstats2 = {fReader, "Jet_btagSF_shape_up_lfstats2"};
   TTreeReaderArray<Float_t> Jet_btagSF_shape_down_lfstats2 = {fReader, "Jet_btagSF_shape_down_lfstats2"};
   TTreeReaderArray<Float_t> Jet_btagSF_shape_up_cferr1 = {fReader, "Jet_btagSF_shape_up_cferr1"};
   TTreeReaderArray<Float_t> Jet_btagSF_shape_down_cferr1 = {fReader, "Jet_btagSF_shape_down_cferr1"};
   TTreeReaderArray<Float_t> Jet_btagSF_shape_up_cferr2 = {fReader, "Jet_btagSF_shape_up_cferr2"};
   TTreeReaderArray<Float_t> Jet_btagSF_shape_down_cferr2 = {fReader, "Jet_btagSF_shape_down_cferr2"};
   TTreeReaderValue<Float_t> btagWeight = {fReader, "btagWeight"};
   TTreeReaderValue<Float_t> btagWeight_up_jes = {fReader, "btagWeight_up_jes"};
   TTreeReaderValue<Float_t> btagWeight_down_jes = {fReader, "btagWeight_down_jes"};
   TTreeReaderValue<Float_t> btagWeight_up_lf = {fReader, "btagWeight_up_lf"};
   TTreeReaderValue<Float_t> btagWeight_down_lf = {fReader, "btagWeight_down_lf"};
   TTreeReaderValue<Float_t> btagWeight_up_hf = {fReader, "btagWeight_up_hf"};
   TTreeReaderValue<Float_t> btagWeight_down_hf = {fReader, "btagWeight_down_hf"};
   TTreeReaderValue<Float_t> btagWeight_up_hfstats1 = {fReader, "btagWeight_up_hfstats1"};
   TTreeReaderValue<Float_t> btagWeight_down_hfstats1 = {fReader, "btagWeight_down_hfstats1"};
   TTreeReaderValue<Float_t> btagWeight_up_hfstats2 = {fReader, "btagWeight_up_hfstats2"};
   TTreeReaderValue<Float_t> btagWeight_down_hfstats2 = {fReader, "btagWeight_down_hfstats2"};
   TTreeReaderValue<Float_t> btagWeight_up_lfstats1 = {fReader, "btagWeight_up_lfstats1"};
   TTreeReaderValue<Float_t> btagWeight_down_lfstats1 = {fReader, "btagWeight_down_lfstats1"};
   TTreeReaderValue<Float_t> btagWeight_up_lfstats2 = {fReader, "btagWeight_up_lfstats2"};
   TTreeReaderValue<Float_t> btagWeight_down_lfstats2 = {fReader, "btagWeight_down_lfstats2"};
   TTreeReaderValue<Float_t> btagWeight_up_cferr1 = {fReader, "btagWeight_up_cferr1"};
   TTreeReaderValue<Float_t> btagWeight_down_cferr1 = {fReader, "btagWeight_down_cferr1"};
   TTreeReaderValue<Float_t> btagWeight_up_cferr2 = {fReader, "btagWeight_up_cferr2"};
   TTreeReaderValue<Float_t> btagWeight_down_cferr2 = {fReader, "btagWeight_down_cferr2"};
   TTreeReaderValue<Float_t> baseW = {fReader, "baseW"};
